function [ sumOutput ] = thatSumCalculator( landerI, Nold, c1, c2, c3,c4, c5, c6 )
...
Sum = Sum + landerI(1)*(topSum/bottomSum); 
...
Sum = Sum + landerI(2)*(topSum/bottomSum); 
...
Sum = Sum + landerI(3)*(topSum/bottomSum); 
...
Sum = Sum + landerI(4)*(topSum/bottomSum); 
...
Sum = Sum + landerI(5)*(topSum/bottomSum); 
...
Sum = Sum + landerI(6)*(topSum/bottomSum); 
